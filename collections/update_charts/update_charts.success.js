...
async function updateChartSuccess(header, body) {
    const cartId = getCartId(); // Nilai parameter
    const productId = 123;
    const endPoint = `/carts/${cartId}/product/quantity/`; // Endpoint dengan parameter diganti
...
module.exports = {updateChartSuccess};
