...
async function deleteItemChart(header, body) {
    const cartId = getCartId(); // Nilai parameter
    const productId='123';
    const endPoint = `/carts/${cartId}/product/${productId}`; // Endpoint dengan parameter diganti
...
module.exports = {deleteItemChart};
