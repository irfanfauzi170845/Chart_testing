...
const deleteitem_ChartFailed = require('../../collections/deleteitem_charts/deleteitem_charts.failed301');
...
const deleteItemFailed = requireAll({
    dirname: path.join(__dirname, '../../test-data/deleteitem_charts/failed301'),
});
